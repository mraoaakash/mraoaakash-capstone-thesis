...
wandb disabled
python main.py -t --gpus 1  --base scripts/configs/154_MPHASIS_clip_imagenet_finetune.yaml --name testing --train True --logdir /mnt/storage/aakashrao/cifsShare/PathLDM/outputs/test_memory
