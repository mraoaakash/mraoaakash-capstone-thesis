...
python -m pytorch_fid /media/chs.gpu/DATA/aakash-work/PathLDM/input/original_images/images.npz /media/chs.gpu/DATA/aakash-work/PathLDM/input/generated_75 
