...
do
    ...
    python -m pytorch_fid /media/chs.gpu/DATA/aakash-work/PathLDM/input/uniform_gen/original/img_npzfile.npz /media/chs.gpu/DATA/aakash-work/PathLDM/input/uniform_gen/gen_$i/images --batch-size 128
done