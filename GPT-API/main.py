...
def get_encoding(MESSAGE, TOKEN_LEN):
    ...
    second_message = f"Please generate a succinct report in {TOKEN_LEN} words from the above information. Exclude any filler words or sentences. If something is not mentioned or specified, exclude it from the report. Low verbosity"
